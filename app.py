...
def run_ocr(image: Image.Image) -> tuple:
    ...
    creds = get_vision_credentials()
    if creds is None:
        return {}, "Error: Credentials tidak ditemukan."
    ...
    try:
        ...
        response     = client.text_detection(image=vision_image, timeout=25)
        ...
        if not full_text:
            return {}, "Teks tidak terdeteksi. Pastikan foto paspor jelas."
